              ...
              <div class="branch-info-item">
                ...
                <div class="branch-info-body box--shadow">
                  <ul class="text-center">
                    <li>Address: Oribanwa,Lagos</li>
                    <li>Email: Ibroheemabdkareem@gmail.com</li>
                    <li>Phone: +2348062301273</li>
                    <li>Web: www.omoyomi.com</li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="branch-info-item">
                ...
                <div class="branch-info-body box--shadow">
                  <ul class="text-center">
                    <li>
                      Address: Shop A4 PRESTIGE PLAZA, BESIDE KUNECH FILLING
                      STATION, BOGIJE.IBEJU LEKKI,LAGOS.
                    </li>
                    <li>Email: Ibroheemabdkareem@gmail.com</li>
                    <li>Phone: +2348062301273</li>
                    <li>Web: www.omoyomi.com</li>
